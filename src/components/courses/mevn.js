...
const MEVNCourse = () => {
  ...
  const handleAddToWishlist = async () => {
    const wishlistItem = {
      img: "../images/mevn2.g",
      desc: "MEVN Stack | Full-Stack Web Development Mastery",
      price: "210.00",
    };
      ...
      <div className="mb-4">
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active" aria-current="page">
              <a href="/mevn" className="text-decoration-none text-dark">
                mevn
              </a>
            </li>
          </ol>
      ...
      >
        <div className="row">
          <div className="col-lg-6 d-flex align-items-center">
            <img
              src="../images/mevn2.jpg"
              alt="MEVN Stack Course"
          ...
          >
            <div>
              <h3 className="fw-bold mb-3" data-aos="fade-down">
                MEVN Stack | Full-Stack Web Development Mastery
              </h3>
              <p className="fs-6 mb-3" data-aos="fade-down">
                <strong>MEVN Stack</strong> is a modern, full-stack JavaScript
                solution comprised of MongoDB, Express, Vue.js, and Node.js.
                Master the MEVN stack and build high-performance web
                applications.
              </p>
              <div
      ...
      >
        ...
        <div className="row text-center">
          <div className="col-lg-4">
            <p>
              "The MEVN stack course is comprehensive and perfect for anyone
              wanting to master full-stack development."
            </p>
            <h6>- Jane P. – Full-Stack Developer</h6>
          </div>
          <div className="col-lg-4">
            <p>
              "Amazing course that covers everything from front-end Vue.js to
              back-end Node.js."
            </p>
            <h6>- Mike T. – Software Engineer</h6>
          </div>
          <div className="col-lg-4">
            <p>
              "The instructor made the complex concepts simple, making MEVN easy
              to understand and apply."
            </p>
            <h6>- Lisa K. – Web Developer</h6>
          </div>
        </div>
      </section>
        ...
        <div className="w-75">
          <ListGroup as="ul">
            ...
            <ListGroup.Item as="li">
              <strong className="fs-6">1. Course Title:</strong> MEVN Stack |
            ...
            <ListGroup.Item as="li">
              <strong className="fs-6">3. Level:</strong> Intermediate to
              Advanced
            </ListGroup.Item>
            <ListGroup.Item as="li">
              ...
              <ul>
                <li>
                  Master MongoDB, Express.js, Vue.js, and Node.js (MEVN Stack).
                </li>
                <li>Build modern, full-stack web applications.</li>
                <li>Handle user authentication and security.</li>
                <li>
            ...
            <ListGroup.Item as="li">
              ...
              <ul>
                <li>Introduction to the MEVN Stack.</li>
                <li>Building a Front-End with Vue.js.</li>
                <li>Creating REST APIs with Express.js.</li>
                <li>Database Management with MongoDB.</li>
                <li>Deployment and Optimization Techniques.</li>
              </ul>
            </ListGroup.Item>
            <ListGroup.Item as="li" disabled>
              <strong className="fs-6">6. Certification:</strong> Certificate of
              Completion after passing the final assessment.
            </ListGroup.Item>
            <ListGroup.Item as="li" disabled>
              <strong className="fs-6">7. Up-to-Date Content:</strong> Latest
              MEVN stack features and best practices.
            </ListGroup.Item>
          </ListGroup>
        </div>
      </div>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                A basic understanding of JavaScript is helpful, and experience
                with front-end or back-end development will be beneficial.
                However, no prior knowledge of the MEVN stack is necessary.
              </div>
            </div>
          </div>
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                Yes, the course includes multiple hands-on projects where you’ll
                create full-stack web applications using the MEVN stack.
              </div>
            </div>
          </div>
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                Support is available via the course's online forum or through
                direct contact with the instructor. More details will be
