...
const FlutterCourse = () => {
  ...
  const handleAddToWishlist = async () => {
    const wishlistItem = {
      img: "../images/f2.png",
      desc: "Flutter Essentials | Mastering Mobile Development 2024",
      price: "80.00",
    };
      ...
      <div className="mb-4">
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active" aria-current="page">
              <a href="/flutter" className="text-decoration-none text-dark">
                flutter
              </a>
            </li>
          </ol>
          ...
          >
            <div>
              <h3 className="fw-bold mb-3">
                Flutter Essentials | Mastering Mobile Development 2024
              </h3>
              <p className="fs-6 mb-3">
                <strong>Flutter</strong> is a powerful UI toolkit developed by
                Google for building natively compiled applications for mobile,
                web, and desktop from a single codebase. This course covers all
                the essentials of Flutter development, including widgets, state
                management, and integrating with backend services.
              </p>
      ...
      >
        ...
        <div className="row text-center">
          <div className="col-lg-4" data-aos="fade-up">
            <p>
              "This Flutter course provided me with a deep understanding of
              mobile app development. The hands-on approach and practical
              examples were very effective."
            </p>
            <h6>- John D. – Mobile Developer</h6>
          </div>
          <div className="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <p>
              "The course content was well-organized and covered all critical
              aspects of Flutter. It helped me build several apps and improve my
              development skills."
            </p>
            <h6>- Sarah K. – App Developer</h6>
          </div>
          <div className="col-lg-4" data-aos="fade-up" data-aos-delay="400">
            <p>
              "I found the course to be both engaging and informative. The
              practical exercises were excellent for understanding how to use
              Flutter effectively."
            </p>
        ...
        <div className="w-75">
          <ListGroup as="ul">
            ...
            <ListGroup.Item as="li">
              <strong className="fs-6">1. Course Title:</strong> Flutter
              Essentials | Mastering Mobile Development 2024
            </ListGroup.Item>
            <ListGroup.Item as="li">
            ...
            <ListGroup.Item as="li">
              ...
              <ul>
                <li>Understand Flutter Basics & Setup.</li>
                <li>Create Cross-Platform Mobile Apps.</li>
                <li>Implement State Management.</li>
                <li>Integrate with APIs & Databases.</li>
            ...
            <ListGroup.Item as="li">
              ...
              <ul>
                <li>Introduction to Flutter & Dart.</li>
                <li>Building User Interfaces with Widgets.</li>
                <li>State Management & Navigation.</li>
                <li>Working with Data & APIs.</li>
                <li>Testing & Debugging Flutter Apps.</li>
                <li>Deploying Apps to App Stores.</li>
              </ul>
            </ListGroup.Item>
            ...
            <ListGroup.Item as="li" disabled>
              ...
              the latest Flutter updates and best practices.
            </ListGroup.Item>
          </ListGroup>
        </div>
      </div>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                ...
                Familiarity with Dart or mobile development concepts will be
                beneficial.
              </div>
            </div>
          </div>
